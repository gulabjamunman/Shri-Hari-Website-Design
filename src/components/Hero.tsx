...
const Hero = ({
  ...
  return <section id="home" className="relative min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Container port and logistics operations" className="w-full h-full object-cover" />
      ...
      <div className="container-wide relative z-10 py-20">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6 animate-fade-up">
            ...
            <span className="text-white/90 text-sm font-medium">10+ Years of Logistics Excellence</span>
          </div>

          {/* Headline */}
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white font-extrabold leading-tight mb-6 animate-fade-up" style={{
          animationDelay: "0.1s"
        }}>
          ...
          {/* Subheadline */}
          <p className="text-xl text-white/80 mb-8 max-w-2xl animate-fade-up" style={{
          animationDelay: "0.2s"
        }}>
          ...
          {/* Transport modes */}
          <div className="flex flex-wrap gap-6 animate-fade-up" style={{
          animationDelay: "0.4s"
        }}>
            {[{
            icon: Truck,
            ...
            icon: Ship,
            label: "Sea Shipping"
          }].map(mode => <div key={mode.label} className="flex items-center gap-3 text-white/80">
